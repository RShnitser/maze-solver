...
class Cell:
    ...
    def draw_move(self, to_cell, undo=False):
        x1 = abs(self._x2 - self._x1) // 2 + self._x1
        y1 = abs(self._y2 - self._y1) // 2 + self._y1
        x2 = abs(to_cell._x2 - to_cell._x1) // 2 + to_cell._x1
        y2 = abs(to_cell._y2 - to_cell._y1) // 2 + to_cell._y1
